...
\title{A programming environment supporting an prototype-based introduction to OOP}
\subtitle{}
...
Another subject of research is a ``debugger'' for the tool \cite{Benn10}. We think that a live and powerful debugger \textit{Smalltalk style} is a rich tool for the understanding of the whole environment behaviour. 
